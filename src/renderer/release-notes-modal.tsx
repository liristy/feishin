...
const GITHUB_COMPARE_URL = 'https://api.github.com/repos/liristy/feishin/compare';
...
const ReleaseNotesContent = ({ onDismiss, version }: ReleaseNotesContentProps) => {
    ...
    const {
        ...
        queryKey: ['github-release', GITHUB_RELEASES_URL, selectedVersion],
        retry: 2,
    });
            ...
            <Stack gap="md">
                ...
                <Group justify="flex-end">
                    <Button
                        ...
                        href={
                            showCompareError
                                ? `https://github.com/liristy/feishin/compare/${latestStableRelease.tag_name}...${toTag(selectedVersion)}`
                                : `https://github.com/liristy/feishin/releases/tag/${toTag(selectedVersion)}`
                        }
                        onClick={onDismiss}
        ...
        return (
            <Stack gap="md">
                ...
                <Group justify="flex-end">
                    <Button
                        component="a"
                        href={`https://github.com/liristy/feishin/releases/tag/${toTag(selectedVersion)}`}
                        onClick={onDismiss}
                        rightSection={<Icon icon="externalLink" />}
                        target="_blank"
                        variant="subtle"
