                ...
                callback({
                    responseHeaders: {
                        ...
                        'Content-Security-Policy': [
                            "script-src 'self' 'wasm-unsafe-eval' 'unsafe-inline' https://umami.jeffvli.org; style-src 'self' 'unsafe-inline'; media-src 'self' http: https: data: blob: feishin-offline:; img-src 'self' http: https: data: blob:; connect-src 'self' http: https: ws: wss: feishin-offline:; default-src 'self';",
                        ],
                    },
                });
            });
